...
export default function RoomTypeFormModal({ roomType, onClose, onSuccess }) {
  ...
  useEffect(() => {
    if (roomType) {
      setForm({
        ...
        // facilities is an array in the normalized object — turn it back
        // into a comma-separated string for the text input
  ...
  async function handleSubmit(e) {
    ...
    const payload = {
      ...
      status: form.status,
      // reverse of the hook's normalization: comma string -> array of
      // trimmed, non-empty strings. If your backend expects a comma
      // string instead of an array, change this to just `form.facilities`.
