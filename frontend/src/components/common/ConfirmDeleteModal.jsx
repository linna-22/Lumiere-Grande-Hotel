  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[60]">
      <div className="bg-base-900 border border-base-border rounded-2xl w-full max-w-sm p-6 text-center">
        ...
        <h2 className="text-white font-serif text-lg font-bold mb-1">Delete {itemLabel}</h2>
        <p className="text-sm text-slate-400 mb-6">
          Are you sure you want to delete {itemName ? `"${itemName}"` : `this ${itemLabel.toLowerCase()}`}? This action cannot be undone.
        </p>
